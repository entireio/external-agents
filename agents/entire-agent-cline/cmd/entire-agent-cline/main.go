...
import (
	...
	"github.com/entireio/external-agents/agents/entire-agent-cline/internal/cline"
	"github.com/entireio/external-agents/agents/entire-agent-cline/internal/protocol"
)
...
func main() {
	...
	if len(os.Args) < 2 {
		fatalf("usage: entire-agent-cline <subcommand> [args]")
	}
