...
func printMarkdown(b briefing.Briefing) {
	...
	if b.History.Available {
		fmt.Printf("## Historical development evidence\n\nSource: %s\n\nStatus: %s\n\nMatched sessions: %d; failed: %d; retries: %d; reverts: %d; max risk score: %.2f\n", b.History.Source, b.History.Status, b.History.MatchedSessions, b.History.FailedSessions, b.History.Retries, b.History.Reverts, b.History.MaxRiskScore)
		section("Ignored JSONL events", b.History.IgnoredEvents)
